...
int main() {
    ...
    std::vector<std::vector<double>> matrix(50000, std::vector<double>(50000, 1.0)); // Reduced size for demonstration
    std::vector<double> vector(50000, 1.0);
    std::vector<double> bias(50000, 1.0);
